...
## Environments
- Preview: https://main--eds-ue-demo--KseniiaBurovetska.aem.page/
- Live: https://main--eds-ue-demo--KseniiaBurovetska.aem.live/
...
1. Open the `eds-ue-demo` directory in your favorite IDE and start coding :)
